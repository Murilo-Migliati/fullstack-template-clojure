...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11729 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11729(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11738 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11738(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11746 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11746(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11750 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11750(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11753 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11753(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11763 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11763(reader);
}
});
...
var G__11873 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11874 = s.append(c);
c = G__11873;
s = G__11874;
continue;
}
