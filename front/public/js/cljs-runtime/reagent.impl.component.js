...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21141 = c;
var G__21141__$1 = (((G__21141 == null))?null:G__21141.prototype);
if((G__21141__$1 == null)){
return null;
} else {
return G__21141__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__21146 = c;
var G__21146__$1 = (((G__21146 == null))?null:G__21146.prototype);
if((G__21146__$1 == null)){
return null;
} else {
return G__21146__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__21153 = c;
var G__21153__$1 = (((G__21153 == null))?null:G__21153.constructor);
if((G__21153__$1 == null)){
return null;
} else {
return G__21153__$1.displayName;
}
})();
...
var G__21154 = c;
var G__21154__$1 = (((G__21154 == null))?null:G__21154.constructor);
if((G__21154__$1 == null)){
return null;
} else {
return G__21154__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__21181 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21182 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21182);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21181);
}});
...
var c = this;
var G__21219_21362 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__21219_21362 == null)){
} else {
reagent.ratom.dispose_BANG_(G__21219_21362);
}
...
var renders_21364 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21365 = cljs.core.first(cljs.core.vals(renders_21364));
...
if((cljs.core.count(renders_21364) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_21364))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_21365)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_21365], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__21291 = o;
reagent.impl.component.goog$module$goog$object.set(G__21291,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__21322 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21323 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21323);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21322);
}});
...
var vec__21326 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21326,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21326,(1),null);
...
var G__21329 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__21329 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__21329);
}
});
}),[]);
