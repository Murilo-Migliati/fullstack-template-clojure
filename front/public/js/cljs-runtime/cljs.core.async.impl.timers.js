...
var i_14229 = (0);
while(true){
if((i_14229 < arr.length)){
(arr[i_14229] = null);

var G__14230 = (i_14229 + (1));
i_14229 = G__14230;
continue;
} else {
}
...
var i_14239 = (self__.level + (1));
while(true){
if((i_14239 <= (new_level + (1)))){
(update[i_14239] = self__.header);

var G__14240 = (i_14239 + (1));
i_14239 = G__14240;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14241 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14241[i]));
} else {
x__$2.forward.push((((i < links_14241.length))?(links_14241[i]):null));
}

if((i < links_14241.length)){
(links_14241[i] = x__$2);
} else {
links_14241.push(x__$2);
}
...
var i_14243 = (0);
while(true){
if((i_14243 <= self__.level)){
var links_14244 = (update[i_14243]).forward;
if((x__$1 === (((i_14243 < links_14244.length))?(links_14244[i_14243]):null))){
(links_14244[i_14243] = (x__$1.forward[i_14243]));

var G__14245 = (i_14243 + (1));
i_14243 = G__14245;
continue;
} else {
var G__14246 = (i_14243 + (1));
i_14243 = G__14246;
continue;
}
} else {
...
var G__14248 = nx;
var G__14249 = (level__$1 - (1));
x = G__14248;
level__$1 = G__14249;
continue;
} else {
var G__14250 = x;
var G__14251 = (level__$1 - (1));
x = G__14250;
level__$1 = G__14251;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__14253 = nx;
var G__14254 = (level__$1 - (1));
x = G__14253;
level__$1 = G__14254;
continue;
} else {
var G__14255 = x;
var G__14256 = (level__$1 - (1));
x = G__14255;
level__$1 = G__14256;
continue;
}
