...
var G__21451 = o;
reagent.impl.template.goog$module$goog$object.set(G__21451,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__21663__delegate = function (args){
...
while (G__21664__i < G__21664__a.length) {G__21664__a[G__21664__i] = arguments[G__21664__i + 0]; ++G__21664__i;}
  args = new cljs.core.IndexedSeq(G__21664__a,0,null);
} 
return G__21663__delegate.call(this,args);};
G__21663.cljs$lang$maxFixedArity = 0;
G__21663.cljs$lang$applyTo = (function (arglist__21665){
var args = cljs.core.seq(arglist__21665);
return G__21663__delegate(args);
});
...
var G__21462 = o;
reagent.impl.template.goog$module$goog$object.set(G__21462,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__21472 = props;
var G__21472__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21472,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21472);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21472__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21483 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21483,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21483;
}
})(),id_class);
...
var vec__21488 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21488,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21488,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21488,(2),null);
...
var temp__5808__auto___21791 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21791 == null)){
} else {
var key_21792 = temp__5808__auto___21791;
(jsprops.key = key_21792);
}
...
var temp__5808__auto___21793 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___21793 == null)){
} else {
var key_21794 = temp__5808__auto___21793;
(jsprops.key = key_21794);
}
...
var temp__5808__auto___21796 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___21796 == null)){
} else {
var key_21797 = temp__5808__auto___21796;
(jsprops.key = key_21797);
}
...
var temp__5808__auto___21854 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___21854 == null)){
} else {
var key_21855 = temp__5808__auto___21854;
(jsprops.key = key_21855);
}
...
var temp__5808__auto___21856 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___21856 == null)){
} else {
var key_21857 = temp__5808__auto___21856;
(jsprops.key = key_21857);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21503_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__21503_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__21509 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21509,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21509,(1),null);
...
var G__21520 = tag;
var G__21520__$1 = (((G__21520 instanceof cljs.core.Keyword))?G__21520.fqn:null);
switch (G__21520__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template21575 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template21575 = (function (opts,id,fn_to_element,parse_fn,meta21576){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template21575.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21577,meta21576__$1){
var self__ = this;
var _21577__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template21575(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta21576__$1));
}));

(reagent.impl.template.t_reagent$impl$template21575.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21577){
var self__ = this;
var _21577__$1 = this;
return self__.meta21576;
}));

(reagent.impl.template.t_reagent$impl$template21575.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template21575.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template21575.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template21575.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template21575.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template21575.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta21576","meta21576",1529136269,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template21575.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template21575.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template21575");

(reagent.impl.template.t_reagent$impl$template21575.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template21575");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template21575.
 */
reagent.impl.template.__GT_t_reagent$impl$template21575 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template21575(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta21576){
return (new reagent.impl.template.t_reagent$impl$template21575(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta21576));
});

}

return (new reagent.impl.template.t_reagent$impl$template21575(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
