...
return [(function (){var pred__21971 = cljs.core.instance_QMARK_;
var expr__21972 = reactive_val;
if(cljs.core.truth_((pred__21971.cljs$core$IFn$_invoke$arity$2 ? pred__21971.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__21972) : pred__21971.call(null,reagent.ratom.RAtom,expr__21972)))){
return "ra";
} else {
if(cljs.core.truth_((pred__21971.cljs$core$IFn$_invoke$arity$2 ? pred__21971.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__21972) : pred__21971.call(null,reagent.ratom.RCursor,expr__21972)))){
return "rc";
} else {
if(cljs.core.truth_((pred__21971.cljs$core$IFn$_invoke$arity$2 ? pred__21971.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__21972) : pred__21971.call(null,reagent.ratom.Reaction,expr__21972)))){
return "rx";
} else {
if(cljs.core.truth_((pred__21971.cljs$core$IFn$_invoke$arity$2 ? pred__21971.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__21972) : pred__21971.call(null,reagent.ratom.Track,expr__21972)))){
return "tr";
} else {
return "other";
}
